...
const fetchMovie = async () => {
  try {
    const res = await axios.get(`http://localhost:3001/api/movies/${route.params.id}`)
...
const fetchActors = async () => {
  try {
    const res = await axios.get(`http://localhost:3001/api/movies/${route.params.id}/actors`)
...
const fetchReviews = async () => {
  ...
  try {
    const res = await axios.get(`http://localhost:3001/api/reviews/${movieId}`)
